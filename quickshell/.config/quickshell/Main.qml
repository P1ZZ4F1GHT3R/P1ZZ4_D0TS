...
FloatingWindow {
    ...
    Component.onCompleted: {
        Quickshell.execDetached(["bash", "-c", `hyprctl dispatch resizewindowpixel "exact 1 1,title:^(qs-master)$" && hyprctl dispatch movewindowpixel "exact 100000 100000,title:^(qs-master)$"`]);
    }

    // Dynamic monitor tracking
    property int activeMx: 0
    property int activeMy: 0
    property int activeMw: 2160
    property int activeMh: 1440
    ...
    property int currentX: 100000
    property int currentY: 100000
    ...
    Timer {
        ...
        onTriggered: {
            ...
            let cmd = `hyprctl dispatch resizewindowpixel "exact 1 1,title:^(qs-master)$" && hyprctl dispatch movewindowpixel "exact 100000 100000,title:^(qs-master)$"`;
